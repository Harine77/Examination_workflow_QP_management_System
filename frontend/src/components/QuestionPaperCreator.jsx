...
import api from '../services/api';  // CHANGED: Use our API service

// CHANGED: Function name from App to QuestionPaperCreator
function QuestionPaperCreator() {
  ...
  const analyzeQuestion = async (part, index) => {
    ...
    setAnalyzing(true);
    try {
      // CHANGED: Use api service
      const response = await api.post('/questions/analyze', {
